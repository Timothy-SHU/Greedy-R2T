    ...
    for line in input_file.readlines():
        ...
        for element in elements[1:]:
            ...
            if element in size_dic.keys():
                # size_dic[element]+=1
                size_dic[element] += aggregation_value
            else:
                # size_dic[element] = 1
                size_dic[element] = aggregation_value
...
def main(argv):
    ...
    try:
        ...
        print("R2T.py -I <input file> -e <epsilon> -b <beta> -G <global sensitivity> -p <processor number>")
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print("R2T.py -I <input file> -e <epsilon> -b <beta> -G <global sensitivity> -p <processor number>")
    ...
    print("Query Result:", real_query_result)
    print("Noised Result:", res)
    print("Error:", abs(res-real_query_result))
    print("Error Rate:", abs(res-real_query_result)/real_query_result*100, "%")
